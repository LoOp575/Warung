    ...
    <>
      ...
      <main className="lg:ml-64 pb-24 lg:pb-8">
        ...
        {activePage === "dashboard" && (
          <DashboardPage omzetHariIni={omzetHariIni} stokBarang={stokBarang} onSimpanOmzet={handleSimpanOmzet} />
        )}
        {activePage === "stok" && (
          <StokPage stokBarang={stokBarang} onUpdateStok={handleUpdateStok} onHapusBarang={handleHapusBarang} onTambahBarang={handleTambahBarang} />
        )}
        {activePage === "grafik" && (
          <GrafikPage omzetHariIni={omzetHariIni} omzetHistory={omzetHistory} />
        )}
        {activePage === "target" && (
          <TargetPage modalData={modalData} onTambahModal={handleTambahModal} />
        )}
      </main>
