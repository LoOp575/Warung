  ...
  return (
    <aside className="hidden lg:flex fixed left-0 top-0 h-full w-64 bg-navy-900 text-white flex-col z-50 shadow-xl">
      <div className="p-6 border-b border-navy-800">
        <h1 className="text-2xl font-bold text-primary-300">WarungNeng</h1>
        <p className="text-xs text-gray-400 mt-1">Manajemen Warung Beta</p>
      </div>
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        {navItems.map((item) => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-navy-800 transition-colors text-left text-sm ${
              activePage === item.id ? "bg-navy-800 text-primary-300" : "text-gray-300"
            }`}
          >
      ...
      <div className="p-4 border-t border-navy-800">
        <p className="text-xs text-gray-500 text-center">WarungNeng Beta v2</p>
      </div>
    </aside>
  );
}
